...
import com.tech.blog.entitties.Category;
	...
	public List<Post> getAllPosts()
	{
		...
		try {
			...
			while(set.next())
			{
				...
				Post post=new Post(pid, pTitle, pContent, pCode, pPic, date, catId, pid);
				list.add(post);
	...
	public Post getPostByPostId(int postId) {
		...
		try {
			...
			if(set.next())
			{
				...
				post=new Post(pid, pTitle, pContent, pCode, pPic, date, cid, pid);
			}
